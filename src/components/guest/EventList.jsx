        ...
        {[
          ...
          <button
            ...
            style={{
              padding: "10px 20px",
              border:
                filter === btn.key ? "2px solid #e74c3c" : "2px solid #ddd",
            ...
            <div style={{ padding: "20px" }}>
              ...
              <div
                style={{
                  ...
                  padding: "4px 12px",
                  background:
                    event.status === "UPCOMING" ? "#2ecc71" : "#95a5a6",
                  color: "white",
                  borderRadius: "15px",
                  fontSize: "12px",
                  fontWeight: "bold",
              ...
              <button
                onClick={() =>
                  event.status === "UPCOMING" && handleRegisterClick(event)
                }
                style={{
                  width: "100%",
                  padding: "12px",
                  background:
                    event.status === "UPCOMING" ? "#e74c3c" : "#95a5a6",
                  color: "white",
                  border: "none",
                  borderRadius: "8px",
                  fontSize: "16px",
                  fontWeight: "500",
                  cursor:
                    event.status === "UPCOMING" ? "pointer" : "not-allowed",
